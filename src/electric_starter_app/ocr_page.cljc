...
;; Old inline toolbar + card table code removed — now uses shared ContentToolbar + ContentCardTable
(comment "removed 350+ lines of duplicated toolbar and card table code"
