...
;; Export modal — extracted to reduce OcrPage bytecode size.
...
;; Pre-prompt dialog — extracted to reduce OcrPage bytecode size.
...
;; Edit card modal — extracted to reduce OcrPage bytecode size.
